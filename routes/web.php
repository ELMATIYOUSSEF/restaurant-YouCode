...
Route::get('/home/TrashedPlat', [PlatlController::class,'TrashedPlat'])->name('plats.TrashedPlat')->middleware('auth');
...
Route::get('/plats/restore/{plat}',[PlatlController::class,'restore'])->name('restore')->middleware('auth');

Route::delete('/plats/ForceDelete/{plat}',[PlatlController::class,'DeleteForce'])->name('deleteForce')->middleware('auth');
